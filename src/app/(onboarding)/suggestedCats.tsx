        ...
        {isLoading ? (
          ...
          <>
            <Text style={{ fontWeight: 'bold', fontSize: 18, padding: 10 }}>
              Here's a quick list of suggested categories for your {recommendation?.userType} use:
            </Text>
            {recommendation ? (
              <SectionList
                sections={sections}
                ...
                renderSectionFooter={({ section: { title } }) => (
                  <TouchableOpacity onPress={() => promptAddSubcategory(title)} style={{ marginLeft: 10, padding: 5 }}>
                    <Text style={{ color: 'blue' }}>add subcategory</Text>
                  </TouchableOpacity>
                )}
            ...
            style={{ padding: 10, backgroundColor: '#ddd', alignItems: 'center', marginTop: 10 }}
            >
