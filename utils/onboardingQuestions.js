export default [
    {
        "id": 1,
        "question": "Which best describes why you’re going to use this app?",
        "answers": [
    ...
    {
        "id": 2,
        "question": "If you’re tracking business expenses, what type of business do you operate?",
        "answers": [
    ...
    {
        "id": 4,
        "question": "Will multiple people need to use or view the same expense data?",
        "answers": [
            "A. Yes, we share finances (e.g., with a partner or business colleague)",
            "B. No, it’s just me",
    ...
    {
        "id": 5,
        "question": "How often will you add or review expenses?",
        "answers": [
            "A. Daily or multiple times a day",
            "B. Weekly",
            "C. Monthly",
            "D. Only for special projects or once in a while"
        ]
    }
]